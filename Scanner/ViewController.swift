...
class ViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    override func viewDidLoad() {
       ...
       // print (testval)
        ...
        let output = verifySignature(publicKey: kpair.pubKey, message: "test message", signature: sig, curve: curve)
        let falsePoint = KPair(curve: curve)
        let falseOutput = verifySignature(publicKey: kpair.pubKey, message: "test message", signature: falsePoint.pubKey, curve: curve)
        print(output)
        print(falseOutput)
