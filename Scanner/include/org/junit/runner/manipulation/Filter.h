...
/*!
 @brief The canonical case of filtering is when you want to run a single test method in a class.
 Rather
...
/*!
 ...
 Only those that pass the filter will be run.
 ...
 */
inline OrgJunitRunnerManipulationFilter *OrgJunitRunnerManipulationFilter_get_ALL();
