...
/*!
 @brief <code>JUnitCore</code> is a facade for running tests.
 It supports running JUnit 4 tests,
...
/*!
 @brief Run all the tests contained in JUnit 3.8.x <code>test</code>.
...
/*!
 @brief Run the tests contained in <code>classes</code>.
