...
/*!
 ...
 in a class.
 The odd name is necessary because <code>class</code> is a reserved word.
...
/*!
 @brief Create a <code>Request</code> that, when processed, will run all the tests
 in a class.
 If the class has a suite() method, it will be ignored.
 @param clazz the class containing the tests
 @return a <code>Request</code> that will cause all tests in the class to be run
 */
...
/*!
 @brief Not used within JUnit.
 Clients should simply instantiate ErrorReportingRunner themselves
 */
+ (OrgJunitRunnerRequest *)errorReportWithIOSClass:(IOSClass *)klass
                                   withNSException:(NSException *)cause __attribute__((deprecated));
...
FOUNDATION_EXPORT OrgJunitRunnerRequest *OrgJunitRunnerRequest_errorReportWithIOSClass_withNSException_(IOSClass *klass, NSException *cause);
