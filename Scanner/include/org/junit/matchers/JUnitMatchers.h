...
/*!
 @brief This is useful for fluently combining matchers that must both pass.
 For example:
 @code
...
FOUNDATION_EXPORT OrgJunitMatchersJUnitMatchers *create_OrgJunitMatchersJUnitMatchers_init();
