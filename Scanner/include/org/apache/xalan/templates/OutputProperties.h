...
/*!
 @brief This class provides information from xsl:output elements.
 It is mainly
...
/*!
 @brief Copy the keys and values from the source to this object.
 This will
...
/*!
 @brief Set an output property with a QName list value.
 The QNames will be turned
...
/*!
 @brief Set an output property with a QName value.
 The QName will be turned
...
inline jlong OrgApacheXalanTemplatesOutputProperties_get_serialVersionUID();
...
FOUNDATION_EXPORT OrgApacheXalanTemplatesOutputProperties *new_OrgApacheXalanTemplatesOutputProperties_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXalanTemplatesOutputProperties *create_OrgApacheXalanTemplatesOutputProperties_init();
