...
/*!
 @brief Visit an XSLT instruction.
 Any element that isn't called by one 
...
/*!
 @brief Visit a predicate within a location path.
...
/*!
 @brief Find the previous occurance of a xsl:variable.
 Stop 
...
inline NSString *OrgApacheXalanTemplatesRedundentExprEliminator_get_PSUEDOVARNAMESPACE();
...
inline jboolean OrgApacheXalanTemplatesRedundentExprEliminator_get_DEBUG();
...
inline jboolean OrgApacheXalanTemplatesRedundentExprEliminator_get_DIAGNOSE_NUM_PATHS_REDUCED();
...
inline jboolean OrgApacheXalanTemplatesRedundentExprEliminator_get_DIAGNOSE_MULTISTEPLIST();
...
FOUNDATION_EXPORT OrgApacheXalanTemplatesRedundentExprEliminator *new_OrgApacheXalanTemplatesRedundentExprEliminator_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXalanTemplatesRedundentExprEliminator *create_OrgApacheXalanTemplatesRedundentExprEliminator_init();
