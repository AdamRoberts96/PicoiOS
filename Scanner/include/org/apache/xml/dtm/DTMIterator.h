...
/*!
 ...
 Their API is modeled largely after the DOM
 NodeIterator.
...
/*!
 ...
 was created.
 Note the root node is not the root node of the 
...
/*!
 @brief Reset the iterator to the start.
 After resetting, the next node returned
...
/*!
 ...
 iterator.
 The available set of constants is defined above.  
...
/*!
 ...
 iterator in the set.
 After a <code>DTMIterator</code> has setRoot called,
...
/*!
 @brief Get the current node in the iterator.
...
/*!
 @brief Returns the <code>node handle</code> of an item in the collection.
 If
 ...
 */
inline jshort OrgApacheXmlDtmDTMIterator_get_FILTER_ACCEPT();
...
/*!
 ...
 Same behavior as FILTER_SKIP. (In the DOM these
 differ when applied to a TreeWalker but have the same result when
 applied to a NodeIterator).
 */
inline jshort OrgApacheXmlDtmDTMIterator_get_FILTER_REJECT();
 ...
 */
inline jshort OrgApacheXmlDtmDTMIterator_get_FILTER_SKIP();
