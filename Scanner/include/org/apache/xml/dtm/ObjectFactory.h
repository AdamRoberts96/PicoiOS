...
FOUNDATION_EXPORT OrgApacheXmlDtmObjectFactory *new_OrgApacheXmlDtmObjectFactory_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlDtmObjectFactory *create_OrgApacheXmlDtmObjectFactory_init();
...
FOUNDATION_EXPORT JavaLangClassLoader *OrgApacheXmlDtmObjectFactory_findClassLoader();
...
inline jlong OrgApacheXmlDtmObjectFactory_ConfigurationError_get_serialVersionUID();
