...
FOUNDATION_EXPORT OrgApacheXmlUtilsIntStack *new_OrgApacheXmlUtilsIntStack_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsIntStack *create_OrgApacheXmlUtilsIntStack_init();
