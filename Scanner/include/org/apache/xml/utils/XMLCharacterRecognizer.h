...
FOUNDATION_EXPORT OrgApacheXmlUtilsXMLCharacterRecognizer *new_OrgApacheXmlUtilsXMLCharacterRecognizer_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsXMLCharacterRecognizer *create_OrgApacheXmlUtilsXMLCharacterRecognizer_init();
