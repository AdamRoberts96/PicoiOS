...
FOUNDATION_EXPORT OrgApacheXmlUtilsSystemIDResolver *new_OrgApacheXmlUtilsSystemIDResolver_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsSystemIDResolver *create_OrgApacheXmlUtilsSystemIDResolver_init();
