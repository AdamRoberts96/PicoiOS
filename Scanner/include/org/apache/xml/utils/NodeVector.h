...
inline jlong OrgApacheXmlUtilsNodeVector_get_serialVersionUID();
...
FOUNDATION_EXPORT OrgApacheXmlUtilsNodeVector *new_OrgApacheXmlUtilsNodeVector_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsNodeVector *create_OrgApacheXmlUtilsNodeVector_init();
