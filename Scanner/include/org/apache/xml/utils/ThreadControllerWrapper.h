...
FOUNDATION_EXPORT OrgApacheXmlUtilsThreadControllerWrapper *new_OrgApacheXmlUtilsThreadControllerWrapper_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsThreadControllerWrapper *create_OrgApacheXmlUtilsThreadControllerWrapper_init();
...
/*!
 @brief Thread controller utility class for incremental SAX source.
 Must 
...
FOUNDATION_EXPORT OrgApacheXmlUtilsThreadControllerWrapper_ThreadController *new_OrgApacheXmlUtilsThreadControllerWrapper_ThreadController_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsThreadControllerWrapper_ThreadController *create_OrgApacheXmlUtilsThreadControllerWrapper_ThreadController_init();
