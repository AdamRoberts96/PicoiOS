...
FOUNDATION_EXPORT OrgApacheXmlUtilsStringBufferPool *new_OrgApacheXmlUtilsStringBufferPool_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsStringBufferPool *create_OrgApacheXmlUtilsStringBufferPool_init();

FOUNDATION_EXPORT OrgApacheXmlUtilsFastStringBuffer *OrgApacheXmlUtilsStringBufferPool_get();
