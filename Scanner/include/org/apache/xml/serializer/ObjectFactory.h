...
FOUNDATION_EXPORT OrgApacheXmlSerializerObjectFactory *new_OrgApacheXmlSerializerObjectFactory_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlSerializerObjectFactory *create_OrgApacheXmlSerializerObjectFactory_init();
...
FOUNDATION_EXPORT JavaLangClassLoader *OrgApacheXmlSerializerObjectFactory_findClassLoader();
...
inline jlong OrgApacheXmlSerializerObjectFactory_ConfigurationError_get_serialVersionUID();
