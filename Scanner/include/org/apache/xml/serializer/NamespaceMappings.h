...
/*!
 @brief This class keeps track of the currently defined namespaces.
 Conceptually the
...
FOUNDATION_EXPORT OrgApacheXmlSerializerNamespaceMappings *new_OrgApacheXmlSerializerNamespaceMappings_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlSerializerNamespaceMappings *create_OrgApacheXmlSerializerNamespaceMappings_init();
