 ...
 */
inline NSString *OrgApacheXmlResXMLMessages_get_BAD_CODE();
 ...
 */
inline NSString *OrgApacheXmlResXMLMessages_get_FORMAT_FAILED();
/*! INTERNAL ONLY - Use accessor function from above. */
...
FOUNDATION_EXPORT OrgApacheXmlResXMLMessages *new_OrgApacheXmlResXMLMessages_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlResXMLMessages *create_OrgApacheXmlResXMLMessages_init();
