...
/*!
 @brief This class bottlenecks all management of source trees.
 The methods
...
FOUNDATION_EXPORT OrgApacheXpathSourceTreeManager *new_OrgApacheXpathSourceTreeManager_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathSourceTreeManager *create_OrgApacheXpathSourceTreeManager_init();
