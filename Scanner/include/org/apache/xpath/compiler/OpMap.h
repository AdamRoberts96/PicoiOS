...
@interface OrgApacheXpathCompilerOpMap : NSObject {
 @public
  ...
  /*!
   @brief TokenStack is the queue of used tokens.
   The current token is the token at the
 ...
 of tokens can be reused.
  ...
  /*!
   @brief An operations map is used instead of a proper parse tree.
   It contains
...
/*!
 @brief Get the opcode list that describes the XPath operations.
 It contains
 operations codes and indexes into the m_tokenQueue.
 I use an array instead of a full parse tree in order to cut down
 on the number of objects created.
...
/*!
 @brief Get the test type of the step, i.e.
 NODETYPE_XXX value.
 @param opPosOfStep The position of the FROM_XXX step.
 ...
 */
inline jint OrgApacheXpathCompilerOpMap_get_MAXTOKENQUEUESIZE();
...
inline jint OrgApacheXpathCompilerOpMap_get_BLOCKTOKENQUEUESIZE();
 ...
 */
inline jint OrgApacheXpathCompilerOpMap_get_MAPINDEX_LENGTH();
...
FOUNDATION_EXPORT OrgApacheXpathCompilerOpMap *new_OrgApacheXpathCompilerOpMap_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathCompilerOpMap *create_OrgApacheXpathCompilerOpMap_init();
