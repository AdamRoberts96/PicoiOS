...
/*!
 @brief Tell if the given axis goes downword.
 Bogus name, if you can think of 
...
/*!
 @brief Create a new LocPathIterator iterator.
...
/*!
 @brief Analyze a step and give information about it's predicates.
 Right now this
...
/*!
 ...
 as a generalized match pattern.
 What this means is that the LocationPath
 ...
 */
inline jboolean OrgApacheXpathAxesWalkerFactory_get_DEBUG_PATTERN_CREATION();
...
/*!
 @brief Set to true for diagnostics about walker creation
 */
inline jboolean OrgApacheXpathAxesWalkerFactory_get_DEBUG_WALKER_CREATION();
 ...
 */
inline jboolean OrgApacheXpathAxesWalkerFactory_get_DEBUG_ITERATOR_CREATION();
...
/*!
 @brief First 8 bits are the number of top-level location steps.
 Hopefully
 there will never be more that 255 location steps!!!
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BITS_COUNT();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BITS_RESERVED();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_PREDICATE();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_ANCESTOR();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_ANCESTOR_OR_SELF();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_ATTRIBUTE();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_CHILD();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_DESCENDANT();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_DESCENDANT_OR_SELF();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_FOLLOWING();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_FOLLOWING_SIBLING();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_NAMESPACE();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_PARENT();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_PRECEDING();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_PRECEDING_SIBLING();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_SELF();
...
/*!
 ...
 function, etc.) step.
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_FILTER();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_ROOT();
...
/*!
 ...
 the given subtree.
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BITMASK_TRAVERSES_OUTSIDE_SUBTREE();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_BACKWARDS_SELF();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_ANY_DESCENDANT_FROM_ROOT();
...
/*!
 @brief Bit is on if any of the walkers contain an node() test.
 This is
 really only useful if the count is 1.
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_NODETEST_ANY();
 ...
 */
inline jint OrgApacheXpathAxesWalkerFactory_get_BIT_MATCH_PATTERN();
...
FOUNDATION_EXPORT OrgApacheXpathAxesWalkerFactory *new_OrgApacheXpathAxesWalkerFactory_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathAxesWalkerFactory *create_OrgApacheXpathAxesWalkerFactory_init();
