...
FOUNDATION_EXPORT OrgApacheXpathAxesHasPositionalPredChecker *new_OrgApacheXpathAxesHasPositionalPredChecker_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathAxesHasPositionalPredChecker *create_OrgApacheXpathAxesHasPositionalPredChecker_init();
