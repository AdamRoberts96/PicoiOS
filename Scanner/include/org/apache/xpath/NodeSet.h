...
/*!
 @brief Add a node to the NodeSet.
 Not all types of NodeSets support this
 operation
...
FOUNDATION_EXPORT OrgApacheXpathNodeSet *new_OrgApacheXpathNodeSet_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathNodeSet *create_OrgApacheXpathNodeSet_init();
