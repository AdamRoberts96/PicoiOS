...
FOUNDATION_EXPORT OrgApacheXpathXPathAPI *new_OrgApacheXpathXPathAPI_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathXPathAPI *create_OrgApacheXpathXPathAPI_init();
