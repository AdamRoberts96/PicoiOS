...
/*!
 @brief Wraps an existing matcher, overriding its description with that specified.
...
@endcode
 @param itemMatcher
 the matcher to apply to every item provided by the examined <code>Iterable</code>
 */
...
/*!
 ...
 <code>itemMatcher</code>.
 Whilst matching, the traversal of the examined <code>Iterable</code>
...
@endcode
 @param itemMatcher
 the matcher to apply to items provided by the examined <code>Iterable</code>
 */
...
@endcode
 @param item
 the item to compare against the items provided by the examined <code>Iterable</code>
 */
...
@endcode
 @param itemMatchers
 the matchers to apply to items provided by the examined <code>Iterable</code>
 */
...
@endcode
 @param items
 the items to compare against the items provided by the examined <code>Iterable</code>
 */
...
FOUNDATION_EXPORT OrgHamcrestCoreMatchers *create_OrgHamcrestCoreMatchers_init();
