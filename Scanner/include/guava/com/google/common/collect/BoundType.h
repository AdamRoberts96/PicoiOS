...
@interface ComGoogleCommonCollectBoundType : JavaLangEnum < NSCopying >
...
inline ComGoogleCommonCollectBoundType *ComGoogleCommonCollectBoundType_get_OPEN();
J2OBJC_ENUM_CONSTANT(ComGoogleCommonCollectBoundType, OPEN)

inline ComGoogleCommonCollectBoundType *ComGoogleCommonCollectBoundType_get_CLOSED();
...
FOUNDATION_EXPORT IOSObjectArray *ComGoogleCommonCollectBoundType_values();
