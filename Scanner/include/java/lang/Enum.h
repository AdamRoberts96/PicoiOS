...
//  source: android/platform/libcore/ojluni/src/objc/java/java/lang/Enum.java
//
...
/*!
 ...
 @since 1.5
 */
@interface JavaLangEnum : NSObject < JavaLangComparable, JavaIoSerializable >

#pragma mark Public

/*!
 @brief Compares this enum with the specified object for order.
 Returns a
...
/*!
 @brief Throws CloneNotSupportedException.
