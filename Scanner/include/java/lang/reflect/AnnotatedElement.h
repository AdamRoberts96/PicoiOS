...
//  source: android/platform/libcore/ojluni/src/objc/java/java/lang/reflect/AnnotatedElement.java
//
...
/*!
 ...
 element <i>E</i> if <i>E</i> has a <code>RuntimeVisibleAnnotations</code>
  or <code>RuntimeVisibleParameterAnnotations</code>
  or <code>RuntimeVisibleTypeAnnotations</code>
...
/*!
 ...
 The caller of this method is free to modify the returned array; it will
 have no effect on the arrays returned to other callers.
  The default implementation first calls <code>getDeclaredAnnotationsByType(Class)</code>
  passing <code>annotationClass</code>
 ...
 then the returned result is the result of calling <code>getAnnotationsByType(Class)</code>
  on the superclass with <code>annotationClass</code>
...
/*!
 ...
 and then loops over the results of <code>getDeclaredAnnotations</code>
...
/*!
 ...
 The caller of this method is free to modify the returned array; it will
 have no effect on the arrays returned to other callers.
  The default implementation may call <code>getDeclaredAnnotation(Class)</code>
  one or more times to find a
 directly present annotation and, if the annotation type is
 repeatable, to find a container annotation. If annotations of
 the annotation type <code>annotationClass</code> are found to be both
 directly and indirectly present, then <code>getDeclaredAnnotations()</code>
  will get called to determine the
 order of the elements in the returned array.
 <p>Alternatively, the default implementation may call <code>getDeclaredAnnotations()</code>
  a single time and the returned array
 examined for both directly and indirectly present
 annotations. The results of calling <code>getDeclaredAnnotations()</code>
  are assumed to be consistent with the
 results of calling <code>getDeclaredAnnotation(Class)</code>.
 @param annotationClass the Class object corresponding to the
 annotation type
 @return all this element's annotations for the specified annotation type if
