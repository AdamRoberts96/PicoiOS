...
//  source: android/platform/libcore/ojluni/src/objc/java/java/lang/StringBuilder.java
//
...
/*!
 @brief A mutable sequence of characters.
 ...
 */
inline jlong JavaLangStringBuilder_get_serialVersionUID();
