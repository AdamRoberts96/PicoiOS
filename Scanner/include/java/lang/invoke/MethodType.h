...
FOUNDATION_EXPORT JavaLangInvokeMethodType *new_JavaLangInvokeMethodType_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaLangInvokeMethodType *create_JavaLangInvokeMethodType_init();
