...
/*!
 @brief A <tt>CharSequence</tt> is a readable sequence of <code>char</code> values.
 This
...
/*!
 @brief Returns the length of this character sequence.
...
/*!
 @brief Returns the <code>char</code> value at the specified index.
 An index ranges from zero
 to <tt>length() - 1</tt>.  The first <code>char</code> value of the sequence is at
 index zero, the next at index one, and so on, as for array
 indexing. </p>
 <p>If the <code>char</code> value specified by the index is a
 <a href="/java/lang/Character.html#unicode">surrogate</a>, the surrogate
 value is returned.
...
/*!
 ...
 The length of the string will be the length of
 this sequence. </p>
...
/*!
 ...
 from this sequence.
 Any char which maps to a <a
 href="/java/lang/Character.html#unicode">surrogate code
...
/*!
 @brief Returns a stream of code point values from this sequence.
 Any surrogate
