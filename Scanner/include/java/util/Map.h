...
/*!
 ...
 if <code>m.containsKey(k)</code> would return
 <code>true</code>.)
...
/*!
 ...
 The default implementation is equivalent to, for this <code>map</code>:
 @code
...
@endcode
 ...
 subinterface <code>java.util.concurrent.ConcurrentMap</code> must document
...
/*!
 @brief A map entry (key-value pair).
 The <code>Map.entrySet</code> method returns
 ...
 the <code>setValue</code> operation on the map entry.
...
FOUNDATION_EXPORT id<JavaUtilComparator> JavaUtilMap_Entry_comparingByKey();

FOUNDATION_EXPORT id<JavaUtilComparator> JavaUtilMap_Entry_comparingByValue();
