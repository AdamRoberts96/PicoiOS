...
//  source: android/platform/libcore/ojluni/src/objc/java/java/util/TreeMap.java
//
...
/*!
 ...
 keys.
 All keys inserted into the map must implement the <code>Comparable</code>
...
/*!
 ...
 @throws ClassCastException if the keys in m are not <code>Comparable</code>,
...
/*!
 ...
 specified value.
 More formally, returns <code>true</code> if and only if
...
/*!
 @brief Version of getEntry using comparator.
 Split off from getEntry
...
/*!
 ...
 costs.
 The type tests needed to check these for key views are
...
/*!
 ...
 Differs from o1.equals(o2) only in
...
@interface JavaUtilTreeMap_NavigableSubMap : JavaUtilAbstractMap < JavaUtilNavigableMap, JavaIoSerializable > {
 ...
 is the exclusive bound. Similarly for the upper bound.
   */
  id lo_, hi_;
  jboolean fromStart_, toEnd_;
  jboolean loInclusive_, hiInclusive_;
...
/*!
 @brief Base class for spliterators.
