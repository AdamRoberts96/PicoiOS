...
/*!
 @brief The root interface in the <i>collection hierarchy</i>.
 A collection
...
/*!
 ...
 its <code>iterator</code>.  Each matching element is removed using
 <code>Iterator.remove()</code>.  If the collection's iterator does not
...
@endcode
 ...
 <p>
 The created <code>Spliterator</code> reports <code>Spliterator.SIZED</code>.
 ...
 spliterator instance (see <code>Spliterators.emptySpliterator()</code>) for
