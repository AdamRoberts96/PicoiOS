...
/*!
 @brief An ordered collection (also known as a <i>sequence</i>).
 The user of this
...
/*!
 ...
 from the list's <code>Iterator</code>.  The spliterator inherits the
...
/*!
 ...
 The default implementation is equivalent to, for this <code>list</code>:
 @code
...
@endcode
 If the list's list-iterator does not support the <code>set</code> operation
 then an <code>UnsupportedOperationException</code> will be thrown when
