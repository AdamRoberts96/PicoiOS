...
//  source: android/platform/libcore/ojluni/src/objc/java/java/util/LinkedList.java
//
...
/*!
 @brief Pops an element from the stack represented by this list.
 In other
...
/*!
 @brief Pushes an element onto the stack represented by this list.
 In other
...
/*!
 ...
 The <code>Spliterator</code> additionally reports <code>Spliterator.SUBSIZED</code>
 and implements <code>trySplit</code> to permit limited parallelism..
...
inline jint JavaUtilLinkedList_LLSpliterator_get_BATCH_UNIT();
...
inline jint JavaUtilLinkedList_LLSpliterator_get_MAX_BATCH();
