...
//  source: android/platform/libcore/ojluni/src/objc/java/java/util/Hashtable.java
//
...
/*!
 @brief This class implements a hash table, which maps keys to values.
 Any
...
/*!
 @brief Creates a shallow copy of this hashtable.
