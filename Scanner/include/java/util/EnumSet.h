...
//  source: android/platform/libcore/ojluni/src/objc/java/java/util/EnumSet.java
//
...
/*!
 @brief A specialized <code>Set</code> implementation for use with enum types.
 All of
...
/*!
 @brief Creates an enum set initialized from the specified collection.
 If
...
/*!
 ...
 @throws NullPointerException if <code>from</code> or <code>to</code> are null
 @throws IllegalArgumentException if <code>from.compareTo(to) > 0</code>
