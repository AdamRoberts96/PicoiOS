...
//  source: android/platform/libcore/ojluni/src/objc/java/java/util/EnumMap.java
//
...
/*!
 @brief A specialized <code>Map</code> implementation for use with enum type keys.
 All
...
/*!
 @brief Creates an enum map initialized from the specified map.
 If the
 specified map is an <tt>EnumMap</tt> instance, this constructor behaves
 identically to <code>EnumMap(EnumMap)</code>.  Otherwise, the specified map
