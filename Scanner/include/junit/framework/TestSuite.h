...
/*!
 @brief Constructs a TestSuite from the given class.
...
/*!
 @brief Returns the name of the suite.
 Not all
...
FOUNDATION_EXPORT JunitFrameworkTestSuite *create_JunitFrameworkTestSuite_init();
