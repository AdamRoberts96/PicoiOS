...
FOUNDATION_EXPORT void ComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_OutputStreamAdapter_initWithComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_Delegate_withId_(ComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_OutputStreamAdapter *self, id<ComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_Delegate> delegate, id nativeOutputStream);

FOUNDATION_EXPORT ComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_OutputStreamAdapter *new_ComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_OutputStreamAdapter_initWithComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_Delegate_withId_(id<ComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_Delegate> delegate, id nativeOutputStream) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_OutputStreamAdapter *create_ComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_OutputStreamAdapter_initWithComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_Delegate_withId_(id<ComGoogleJ2objcIoAsyncPipedNSInputStreamAdapter_Delegate> delegate, id nativeOutputStream);
